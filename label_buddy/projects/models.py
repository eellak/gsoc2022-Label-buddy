...
def auto_delete_logo_on_change(sender, instance, **kwargs):
    ...
    """
    Deletes old logo from filesystem when corresponding project object is updated with a new file.
    """
...
def set_users_avatar(sender, instance, **kwargs):
    ...
    """
    If project's logo is not specified set it to the unknown icon project.
    """
